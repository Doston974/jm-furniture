...
const Popular = () => {
  ...
  return (
    <div className="mt-16 overflow-hidden text-center relative ">
      <Heading
        title="ENG MASHXURLAR"
        description="BIZ O'Z MIJOZLARIMIZGA DOIM ENG YAXSHISINI TAKLIF ETAMIZ"
      />
              ...
              {products.slice(7, 10).map((item, index) => (
                <div key={index} className="mx-auto max-w-xs relative h-full">
                  ...
                  <div className="mt-5">
                    <button
                      type="button"
                      className="bg-black text-white md:p-4 md:text-sm text-[12px] p-1 hover:bg-red-600 uppercase font-bold"
                    >
                      Savatga qo'shish
                    </button>
                  </div>
